export const blogs = [
  {
    _id: "1",
    title:
      "Budget-Friendly Plumbers: How to Refresh Your Space Without Breaking the Bank",
    excerpt:
  ...
  },
  {
    ...
    alt: "Smiling couple sitting on floor after completing a home Plumbers project, surrounded by paint cans, brushes, and ladder",
  },
].map((blog) => ({
  ...blog,
  slug: blog.title
