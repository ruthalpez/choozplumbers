  ...
  const submitForm = async () => {
    ...
    try {
      const submissionData = {
        ...formData,
        source: "Chooz Plumbers Customer Lead Submission",
  ...
  return (
    <div className="w-full max-w-xl mx-auto overflow-hidden">
      ...
      <div className="px-4 py-6 sm:p-8 bg-white">
        ...
        {currentStep === 4 && (
          <SurveyFormStep8
            additionalText={`Your request has been submitted successfully. You should expect to hear from ${contractorName} or a Chooz Plumbers representative soon.`}
          />
        )}
      </div>
    </div>
