...
import Logo from "@/images/logo/chooz_plumbers_transparent_logo_2.png";
...
const quickLinks = [
  ...
  { label: "Add your company", href: "/claim-plumbers-contractor" },
      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5">
        <div className="py-10 flex flex-wrap gap-10 md:gap-20">
          <div>
            ...
            <div className="mt-4">
              <Link
                href={"mailto:support@choozplumbers.com"}
                prefetch={false}
                className="flex items-center gap-2 mb-2">
                <BsEnvelope />
                <span>support@choozplumbers.com</span>
              </Link>
            </div>
