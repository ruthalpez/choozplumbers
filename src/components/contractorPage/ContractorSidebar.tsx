...
import BadgeVerified from "@/images/badge/chooz_plumbers_verified_plumbers.png";
import BestPainterAward from "@/images/badge/chooz_plumbers_best_plumber_award.png";
import TopPainterAward from "@/images/badge/chooz_plumbers_top_plumber_award.png";
                ...
                <div key={index}>
                  {painter.scores?.map((score, i) => (
                    <div key={i}>
                      {score.score >= 94 && (
                        <Image
                          src={BestPainterAward}
                          alt={`${painter.title} has been given a Chooz Plumbers ${painter.awards} Award in gold badge in 2025`}
                          width={85}
                          height={85}
                          priority
                      ...
                      {score.score >= 87 && score.score < 94 && (
                        <Image
                          src={TopPainterAward}
                          alt={`${painter.title} has been given a Chooz Plumbers ${painter.awards} Award in silver badge in 2025`}
                          width={85}
                          height={85}
                          priority
                          className="w-[85px] h-[85px] object-contain"
                      ...
                      {score.score >= 80 && score.score < 87 && (
                        <Image
                          src={BadgeVerified}
                          alt={
                            "Chooz Plumbers Certified badge in 2025 for S & M Painter & Drywall Co"
                          }
                          width={78}
                          height={78}
          ...
          <div className="mt-8 mb-12 about-text">
            ...
            <div className="about-text">
              {painter.description ? (
                ...
                <>
                  <p className="mb-6">
                    {painter.title} - Plumbers in {painter.city} City,{" "}
                    {painter.state}.
                  </p>
