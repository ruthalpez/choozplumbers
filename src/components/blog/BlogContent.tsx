    ...
    <div className="w-full lg:w-3/4">
      {id === "1" && (
        <div className="space-y-4 mb-6">
          ...
          <ul className="space-list mb-4 list-disc pl-5">
            <li>
              <b>The Power of the Accent Wall:</b> Plumbers just one wall in a
            ...
            <li>
              ...
              brighten the entire room significantly. Plumbers interior doors
      ...
      {id === "2" && (
        <div className="space-y-4 mb-6">
          ...
          <ul className="space-list mb-4 list-decimal pl-5">
            ...
            <li>
              <b>Time and Convenience:</b> Plumbers can be time-consuming,
