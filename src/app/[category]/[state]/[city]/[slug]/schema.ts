...
export const generateSchema = (contractor: any, p: any) => {
  ...
  const websiteId = "https://choozplumbers.com/#website";
  const orgId = "https://choozplumbers.com/#org";
  ...
  const getAllServices = () => {
    ...
    return uniqueServices.length > 0
      ? uniqueServices
      : ["Interior Plumbers", "Exterior Plumbers", "Cabinet Plumbers", "Commercial Plumbers"];
  };
  ...
  const businessServices =
    allServices.length > 0
      ? allServices
      : ["Interior Plumbers", "Exterior Plumbers", "Commercial Plumbers"];
  ...
  const simplifiedSchema = prune({
    ...
    isPartOf: {
      "@type": "WebSite",
      "@id": websiteId,
      name: "Chooz Plumbers Directory",
      url: "https://choozplumbers.com",
    },
    publisher: {
      "@type": "Organization",
      "@id": orgId,
