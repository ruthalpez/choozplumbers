  ...
  try {
    ...
    const description =
      ...
      `${contractorName} provides professional ${category.replace(
        "-",
        " ",
      )} services in ${cityName}, ${stateCode}. Licensed, insured, and highly rated Plumbers Contractor. Get free quotes and read customer reviews.`;
    ...
    return {
      ...
      description,
      robots,
      keywords: `${contractorName}, ${categoryName}, ${cityName} ${stateCode}, Plumbers Contractor, house painter, commercial painting`,
      openGraph: {
        title,
        description,
        url: fullUrl,
    ...
    return {
      title: "ChoozPainters - Professional Plumbers Contractors",
      description: "Find professional Plumbers Contractors in your area.",
      robots: "index, follow",
    };
  }
}
