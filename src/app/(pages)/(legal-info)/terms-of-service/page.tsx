      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Plumbers Terms of Service
          </h1>
          <p>
            These Terms of Service govern your use of the website located at
            https://choozplumbers.com and any related services provided by Chooz
            Painters.
          </p>
          <p>
            By accessing https://choozplumbers.com, you agree to abide by these
            ...
            other services provided by Chooz Plumbers.
          </p>
          <p>
            We, Chooz Plumbers, reserve the right to review and amend any of
          ...
          <p>These Terms of Service were last updated on April 16, 2025.</p>
        </div>

        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Limitations of Use</h2>
          <p>
          ...
          <ul className="space-list list-disc pl-5">
            ...
            <li>
              ...
              other service Chooz Plumbers provides
            </li>
            <li>
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            are owned by or licensed to Chooz Plumbers and are protected by
          ...
          <p>
            ...
            Chooz Plumbers at any time.
          </p>
        </div>

        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Liability</h2>
          <p>
            Our website and the materials on our website are provided on an 'as
            is' basis. To the extent permitted by law, Chooz Plumbers makes no
          ...
          <p>
            In no event shall Chooz Plumbers or its suppliers be liable for any
            ...
            materials on this website, even if Chooz Plumbers or an authorized
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            for general information purposes only. Chooz Plumbers does not
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Links</h2>
          <p>
            Chooz Plumbers has not reviewed all of the sites linked to its
            website and is not responsible for the contents of any such linked
            site. The inclusion of any link does not imply endorsement, approval
            or control by Chooz Plumbers of the site. Use of any such linked
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Right to Terminate</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Severance</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Governing Law</h2>
          <p>
