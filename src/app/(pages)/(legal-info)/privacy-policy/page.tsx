      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Plumbers Privacy Policy
          </h1>
          <p>
            Your privacy is important to us. It is Chooz Plumbers's policy to
            ...
            you, including across our website, https://choozplumbers.com, and
          ...
          <p>This policy is effective as of April 16, 2025</p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Log Data</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Device Data</h2>
          <p>
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            content to us, when you subscribe to our newsletter, when you
            register an account or when you contact us — which may include one
            or more of the following:
          </p>
          <ul className="space-list list-disc pl-5">
            <li>Name</li>
            <li>Email</li>
            <li>Phone/mobile number</li>
            <li>All data entered by the listing businesses</li>
          </ul>
        </div>
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            following on our website: Register for an account Sign up to receive
            updates from us via email or social media channels Use a mobile
            device or web browser to access our content Contact us via email,
            social media, or on any similar technologies When you mention us on
            social media
          </p>
          <ul className="space-list mb-4 list-disc pl-5">
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Children’s Privacy</h2>
          <p>
        ...
        <div className="mb-5">
          ...
          <p>
            <b>Marketing permission:</b> If you have previously agreed to us
          ...
          <p>
            <b>Unsubscribe:</b> To unsubscribe from our email database or
            opt-out of communications (including marketing communications),
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Use of Cookies</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Business Transfers</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Do Not Track</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Cookies and Pixels</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Shine the Light</h2>
          <p>
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Contact Us</h2>
          <p>
