      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Plumbers Acceptable Use Policy
          </h1>
          <p>
            ...
            by Chooz Plumbers under any ongoing agreement. It’s designed to
            protect us, our customers and the general Internet community from
            unethical, irresponsible and illegal activity.
          </p>
          <p>
            Chooz Plumbers customers found engaging in activities prohibited by
          ...
          <p>This policy was last reviewed on April 16, 2025.</p>
        </div>

        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">Fair use</h2>
          <p>
        ...
        <div className="mb-5">
          ...
          <ul className="space-list mb-4 list-[lower-roman] pl-5">
            <li>
          ...
          <h3 className="font-poppins text-[25px] mb-4 text-[var(--clr-heading)]">
            Unauthorized use of Chooz Plumbers property
          </h3>
          <p>
            We prohibit the impersonation of Chooz Plumbers, the representation
            of a significant business relationship with Concierge Doctor HQ, or
            ownership of any Chooz Plumbers property (including our Products and
        ...
        <div className="mb-5">
          <h2 className="heading-secondary font-poppins">About this policy</h2>
          <p>
