...
import CertifiedPainters from "@/images/badge/chooz_plumbers_verified_plumbers.png";
import BestPainter from "@/images/badge/chooz_plumbers_best_plumber_award.png";
import TopPainter from "@/images/badge/chooz_plumbers_top_plumber_award.png";

import VerifiedContractors from "@/images/chooz_plumbers__verified_contractor.png";
import RealReviewAnalysis from "@/images/chooz_plumbers_top_plumber_real_review_analysis.png";
import AIOptimizedProfiles from "@/images/chooz_plumbers_ai_optimized_profiles.png";
...
const jsonLd = {
  ...
  "@type": "Organization",
  name: "choozplumbers",
  url: "https://www.choozplumbers.com/",
  logo: "https://www.choozplumbers.com/images/choozplumbers-logo.png",
  description: "Find local painters and painting companies in your area.",
  sameAs: [
    "https://www.facebook.com/choozplumbers",
    "https://twitter.com/choozplumbers",
    "https://www.linkedin.com/company/choozplumbers",
  ],
  contactPoint: {
    "@type": "ContactPoint",
...
export default async function Home() {
  return (
    <main>
      ...
      <div className="container xl:max-w-6xl mx-auto px-5 pt-5 pb-10">
        <div className="py-10">
          <h2 className="md:text-center text-[35px] lg:text-[48px] leading-10 lg:leading-15 text-[var(--clr-heading)] font-medium font-poppins">
            Chooz Plumbers Directory Standards
          </h2>
          <div className="border-b-[3px] border-[var(--clr-tertiary)] max-w-[180px] md:max-w-[275px] md:mx-auto my-[30px]" />
          <div className="!space-y-6">
            <p>
              Chooz Plumbers specializes in finding, researching, and verifying
              Plumbers contractors around the country. Our process ensures that
              you get a snapshot of all of most important information to compare
              Plumbers companies in your local area. This ensures that you can
              quickly contact multiple Plumbers companies without having to
              waste time searching all over the internet to find the best
              Plumbers professionals for your next painting project.
            </p>
          </div>
          <div className="flex flex-wrap items-center md:items-start justify-center my-10 gap-15 md:gap-0">
            <ImageBox
              image={ResearchPainters.src}
              alt="Icon showing three painting company storefronts labeled ABC Plumbers, Star Plumbers, and XYZ Plumbers, representing comparison of local painters"
              heading="Research Painters"
              className="w-[200px]"
            />
            <div className="hidden md:block mt-16 flex-1 border-t-2 border-black border-dashed" />
            <ImageBox
              image={CertifiedPainters.src}
              alt="Chooz Plumbers Certified Badge for 2025"
              heading="Chooz Plumbers Certified"
              className="w-[200px]"
            />
            <div className="hidden md:block mt-16 flex-1 border-t-2 border-black border-dashed" />
            <ImageBox
              image={TopPainter.src}
              alt="Icon of a painter's tool kit inside a hexagon badge, representing an online platform to find local Plumbers Contractors"
              heading="Top Painter Award"
              className="w-[200px]"
            />
            <div className="hidden md:block mt-16 flex-1 border-t-2 border-black border-dashed" />
            <ImageBox
              image={BestPainter.src}
              alt="Icon of a painter's tool kit inside a hexagon badge, representing an online platform to find local Plumbers Contractors"
          ...
          <div className="flex flex-col lg:flex-row gap-15 lg:gap-30">
            <div className="w-full lg:w-[60%]">
              ...
              <p>
                ...
                Chooz Plumbers scoring system, which considers over 40 factors
      ...
      {/* Find Plumbers Technicians Near You */}
      <div className="bg-[#f4f4f4]">
        ...
        <div className="pt-10">
          <div className="flex flex-col lg:flex-row gap-15 lg:gap-30">
            <div className="w-full lg:w-2/3">
              <h2 className="text-[35px] lg:text-[48px] leading-10 lg:leading-15 text-[var(--clr-heading)] font-medium font-poppins">
                We Help You Find The Top Plumbers In Your Area
              </h2>
              <div className="border-b-[3px] border-[var(--clr-tertiary)] max-w-[275px] my-[30px]" />
              <p>
                Part of what makes Chooz Plumbers different from other
                directories is that we only gather the information you need to
                make an effective comparison between the Plumbers contractors in
            ...
            <div className="w-full lg:w-1/3">
              <Image
                ...
                alt="Illustration of two people in a blue and white hot air balloon with the Chooz logo, representing Plumbers directory exploration and discovery"
                width={300}
                height={300}
